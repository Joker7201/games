...
final class ExtensionSet
{
    ...
    public function addExtension(ExtensionInterface $extension): void
    {
        ...
        if ($this->initialized) {
            throw new \LogicException(sprintf('Unable to user extension "%s" as extensions have already been initialized.', $class));
        }

        if (isset($this->extensions[$class])) {
            throw new \LogicException(sprintf('Unable to user extension "%s" as it is already registered.', $class));
        }
